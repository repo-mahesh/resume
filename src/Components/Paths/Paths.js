...
export default function Paths() {
  return (
    <div className="fixed top-4 right-1 w-max max-w-sm px-4 bg-teal-500">nnnnn
      <Popover className="relative">
        {({ open }) => (
          <>
            ...
            >
              <Popover.Panel className="overflow-x-hidden absolute left-1/2 z-10 mt-3 w-screen max-w-sm -translate-x-1/2 transform px-4 sm:px-0 lg:max-w-3xl">
